# Usage:
#  env NETUSER=douglaso bash scripts/utility/instance_setup.sh
#
...
: "${NETUSER:?Error: please set NETUSER e.g. env NETUSER=myalias bash scripts/utility/instance_setup.sh}"
